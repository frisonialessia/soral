...
import { LayoutDashboard, ClipboardCheck, BarChart3, Plug, Settings, ShieldCheck } from "lucide-react";
...
interface NavItem {
  href: string;
  labelKey: "dashboard" | "interventions" | "reports" | "integrations" | "admin" | "model";
